...
import { deleteSingleTodo, getSingleTodo, reduceTotalTodos } from '../Redux/Todo/action';
...
const SingleTodo = () => {
  ...
  const curTodo = useSelector(store => store.todoReducer.curTodo, shallowEqual);
  const error = useSelector(store => store.todoReducer.error)
